...
namespace CommandHandlerNode
{
    class CommandHandler
    {
        ...
        public CommandHandler()
        {
            ...
            double[] fillingAction = [0.660, 0.840, 0];

            //Motion Functions of the stoppering line------------------------------------------------------------
            //---------------------------------------------------------------------------------------------------

            double[] stopperingAction = [0.660, 0.120, 0];

            //Motion Functions of the vision line----------------------------------------------------------------
            //---------------------------------------------------------------------------------------------------

            double[] visionAction = [0.120, 0.120, 4.7123888];

            //Passing positions to the queues------------------------------------------------------
            //---------------------------------------------------------------------------------------------------
            double[] fillingQueuePosX = { 0.420, 0.290, 0.160 };
            ...
            double[] endQueuePosY = { 0.780, 0.650, 0.520, 0.390 };
