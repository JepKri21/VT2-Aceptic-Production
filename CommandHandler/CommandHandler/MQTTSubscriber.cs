...
namespace CommandHandlerNode
{
    class MQTTSubscriber
    {
        ...
        public MQTTSubscriber(string broker, int port) //also the topic here is not in Jeppes code
        {
            var factory = new MqttFactory();
            _mqttClient = factory.CreateMqttClient();
            //_topic = topic; //He is commented out here
            ...
            //_mqttClient.ConnectedAsync += ConnectedHandler; //Maybe delete
